...
#define ECON1            0x1F
// Bank 0 registers
#define ERDPT            (0x00|0x00)	/* AP - Added */
...
extern void writeReg(uint8_t address, uint16_t data);
extern void enc28j60ReadBuffer(uint16_t len, uint8_t* data);
extern void enc28j60ReadBuffer2(uint16_t len, uint8_t* data);
...
extern void enc28j60PacketSend2(uint16_t len, uint8_t* packet);
extern uint16_t enc28j60PacketReceive(uint16_t maxlen, uint8_t* packet);
extern uint16_t enc28j60PacketReceive2(uint16_t maxlen, uint8_t* packet);
