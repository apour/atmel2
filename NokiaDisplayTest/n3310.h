#include <stdio.h>
#include <avr/pgmspace.h>	// pro ulozeni obrazku do programove pameti

#ifndef _3310_ROUTINES_H_
#define _3310_ROUTINES_H_

#define SET_DC_PIN                 PORTB |= _BV(PB0)  
#define CLEAR_DC_PIN               PORTB &= ~_BV(PB0)
#define SET_SCE_PIN                PORTB |= _BV(PB2)  
#define CLEAR_SCE_PIN              PORTB &= ~_BV(PB2)
...
////***** Mala pismena a znaky **********
//
static const char smallFont[] PROGMEM=
{
     ...
     0x00, 0x00, 0x06, 0x09, 0x06,   // ^ = stupen
